...
def get_indexes_of_filtered_errors(ERROR_TYPE_DF_PATH, PICK_AN_ERROR_INDEX, count_tag_in_cell_function):
    ...
    df3['Error Counts'] = df3[errors[PICK_AN_ERROR_INDEX]].map(count_tag_in_cell_function)
